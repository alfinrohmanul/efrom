                  ...
                  <form action="{{ route('home.store') }}" method="POST">
                    ...
                    <table style="width: 100%;">
                      <tr>
                        ...
                        <td>
                          <select name="puk_id" id="puk_id" class="form-control" required>
                            ...
                            @foreach ($puks as $puk)
                              <option value="{{ $puk->id }}">{{ $puk->nama }}</option>
                            @endforeach
                          </select>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>:</td>
                        <td>
                          <input type="text" name="jenis_produksi" id="jenis_produksi" class="form-control" readonly required>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex justify-content-between mb-1">
                            <div>Perempuan</div>
                            <div><input type="text" name="jumlah_pekerja_perempuan" id="jumlah_pekerja_perempuan" class="form-control" style="text-align: right;"></div>
                          </div>
                          <div class="d-flex justify-content-between mb-1">
                            <div>Laki - laki</div>
                            <div><input type="text" name="jumlah_pekerja_laki" id="jumlah_pekerja_laki" class="form-control" style="text-align: right;"></div>
                          </div>
                          ...
                          <div class="d-flex justify-content-between mb-1">
                            <div>Total</div>
                            <div><input type="text" name="jumlah_pekerja_total" id="jumlah_pekerja_total" class="form-control" style="text-align: right;" required></div>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div class="d-flex justify-content-between mb-1">
                            <div>Perempuan</div>
                            <div><input type="text" name="jumlah_anggota_perempuan" id="jumlah_anggota_perempuan" class="form-control" style="text-align: right;"></div>
                          </div>
                          <div class="d-flex justify-content-between mb-1">
                            <div>Laki - laki</div>
                            <div><input type="text" name="jumlah_anggota_laki" id="jumlah_anggota_laki" class="form-control" style="text-align: right;"></div>
                          </div>
                          <div class="d-flex justify-content-end mb-1">
                          ...
                          <div class="d-flex justify-content-between mb-1">
                            <div>Total</div>
                            <div><input type="text" name="jumlah_anggota_total" id="jumlah_anggota_total" class="form-control" style="text-align: right;" required></div>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>:</td>
                        <td>
                          <input type="text" name="besaran_upah" id="besaran_upah" class="form-control" required>
                        </td>
                      </tr>
                      <tr>
                        <td>Kode COS</td>
                        <td>:</td>
                        <td>
                          <input type="text" name="kode_cos" id="kode_cos" class="form-control" readonly required>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>:</td>
                        <td>
                          <input type="text" name="besaran_iuran_per_orang" id="besaran_iuran_per_orang" class="form-control" readonly required>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <div class="d-flex justify-content-between">
                            <div><input type="text" name="jumlah_iuran_dpp" id="jumlah_iuran_dpp" class="form-control" readonly required></div>
                            ...
                            <div><input type="text" name="jumlah_iuran_dpp_hasil" id="jumlah_iuran_dpp_hasil" class="form-control" readonly required></div>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td>Periode Bulan</td>
                        <td>:</td>
                        <td><input type="date" name="periode" id="periode" class="form-control" value="{{ date('Y-m-d') }}" required>
                        </td>
                      </tr>
                      <tr>
                        <td>Jenis Setoran</td>
                        <td>:</td>
                        <td><input type="text" name="jenis_setoran" id="jenis_setoran" class="form-control" value="Transfer Bank" readonly required></td>
                      </tr>
                      <tr>
                        <td>Rekening Atas Nama</td>
                        <td>:</td>
                        <td>
                          <input type="text" name="rekening_a_n" id="rekening_a_n" class="form-control" required>
                        </td>
                      </tr>
                    </table>
                    <div class="row">
                      <div class="col text-right">
                        <button id="btn_submit" class="btn btn-primary mt-3"><i class="fas fa-paper-plane"></i> Submit</button>
                      </div>
                    </div>
                  </form>
                </div>
...
<script>
  $(document).ready(function() {
    ...
    // iuran dpp
    // let jumlah_iuran_dpp = document.getElementById("jumlah_iuran_dpp");
    // jumlah_iuran_dpp.addEventListener("keyup", function(e) {
    //   const val = $('#jumlah_iuran_dpp').val().replace(/\./g,"");
    //   const calVal = Number(val) * 0.45;
    //   $('#jumlah_iuran_dpp_hasil').val(rupiahJs(Math.floor(calVal)));
    //   jumlah_iuran_dpp.value = rupiahJsKeyup(this.value, "");
    // });
  })
</script>
@endsection